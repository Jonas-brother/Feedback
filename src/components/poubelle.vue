 <!--
      ...
      <a class="navbar-brand" href="#">Feed-WEBBU-Back</a>
        <RouterLink to="/">Home</RouterLink>
        <RouterLink to="/test">test</RouterLink>
        <RouterLink to="/num">num</RouterLink>
...
export default {
  data(){
    return {
      data:["manger","dormir","dessiner","jouer"],
      longueur: ''
    }
  },
}
...
<template>
<div >
<li v-for="dat in data">
    {{ dat }}
</li>
<p> Votre liste fait {{ data.length }} éléments </p>
</div>
</template>
...
<template>
<div >
<input type = number v-model="num" placeholder = "Rentrer un nombre entre 0 et 100" />
<input type = number v-model="factor" placeholder = "Factor" />
<p>Votre nombre est désormais {{ result }}.</p>
</div>
</template>
...
<div class = "container fluid">
    <div class = "row cus">
        ...
        <div id ="answer" class = "row">
            <div>Qu'est-ce qui vous a poussé(e) à faire appel à nous ?</div> 
                {{answer.a}}
        </div>
